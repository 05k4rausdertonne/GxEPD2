...
class GxEPD2_370_GDEY037T03 : public GxEPD2_EPD
{
  public:
    ...
    static const bool useFastFullUpdate = true;         // set false for extended (low) temperature range, 1500000us vs 2000000us
    static const uint16_t power_on_time = 50;           // ms, e.g. 45000us
    static const uint16_t power_off_time = 50;          // ms, e.g. 45000us
    static const uint16_t full_refresh_time = 1500;     // ms, e.g. 1500000us
    static const uint16_t partial_refresh_time = 300;   // ms, e.g. 300000us
    ...
    void writeScreenBuffer(uint8_t value = 0xFF);       // init current controller memory (default white)
    ...
    void writeImage(const uint8_t* black, const uint8_t* color, int16_t x, int16_t y, int16_t w, int16_t h,
                    bool invert = false, bool mirror_y = false, bool pgm = false);
    void writeImagePart(const uint8_t* black, const uint8_t* color, int16_t x_part, int16_t y_part,
    ...
    void drawImage(const uint8_t* black, const uint8_t* color, int16_t x, int16_t y, int16_t w, int16_t h,
                   bool invert = false, bool mirror_y = false, bool pgm = false);
    void drawImagePart(const uint8_t* black, const uint8_t* color, int16_t x_part, int16_t y_part,
                       int16_t w_bitmap, int16_t h_bitmap, int16_t x, int16_t y, int16_t w, int16_t h,
                       bool invert = false, bool mirror_y = false, bool pgm = false);
    ...
    void refresh(int16_t x, int16_t y, int16_t w, int16_t h);  // screen refresh from controller memory, partial window
  ...
  private:
    ...
    void _writeImage(uint8_t command, const uint8_t bitmap[], int16_t x, int16_t y, int16_t w, int16_t h,
                     bool invert = false, bool mirror_y = false, bool pgm = false);
    void _writeImagePart(uint8_t command, const uint8_t bitmap[], int16_t x_part, int16_t y_part,
                          int16_t w_bitmap, int16_t h_bitmap, int16_t x, int16_t y, int16_t w, int16_t h,
                          bool invert = false, bool mirror_y = false, bool pgm = false);
